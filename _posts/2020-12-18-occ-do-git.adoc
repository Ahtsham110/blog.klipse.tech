...
content="Ultimately, we have seen in the book how DO deals with the requests, now in this chapter we illustrate how DO deals with mutations, i.e. requests that change the system state.">
